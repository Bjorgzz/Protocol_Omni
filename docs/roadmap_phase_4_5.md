...
## Skill Expansion (v16.5.0) - 2026-01-26

**Mandate**: Import Critical Five from VoltAgent catalog to close capability gaps.

| Skill | Category | Rationale |
|-------|----------|-----------|
| `sre-engineer` | Infrastructure | Sovereign bare-metal reliability |
| `performance-engineer` | Quality | Quantization, tensor parallelism, BIOS tuning |
| `llm-architect` | Data & AI | Cognitive Trinity design (Phase 4) |
| `kubernetes-specialist` | Infrastructure | K3s layer oversight |
| `error-detective` | Quality | Force multiplier for systematic-debugging |

### Import Status
- [x] `sre-engineer` - IMPORTED (2026-01-26)
- [x] `performance-engineer` - IMPORTED (2026-01-26)
- [x] `llm-architect` - IMPORTED (2026-01-26)
- [x] `kubernetes-specialist` - IMPORTED (2026-01-26)
- [x] `error-detective` - IMPORTED (2026-01-26)
